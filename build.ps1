...
echo "compiling"
& "$ODIN_PATH/odin.exe" build src -target:js_wasm32 -show-system-calls -define:SDL3_WASM_LIB="c:/abotero/webtest/libsdl3.o" -build-mode:obj -out:game.wasm.o -debug

echo "linking"
emcc -o index.html .\game.wasm.o .\libSDL3.a --shell-file .\index_template.html -sERROR_ON_UNDEFINED_SYMBOLS=0 -sFETCH -g
